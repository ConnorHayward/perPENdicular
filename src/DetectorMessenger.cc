 ...
 fLYCMD(0),fResCMD(0),fDetNameCMD(0),fABSCMD(0)
{
  ...
  fPositionCMD = new G4UIcmdWithADoubleAndUnit("/PEN/det/setPosition",this);
  fPositionCMD->SetGuidance("Set Position");
...
void DetectorMessenger::SetNewValue(G4UIcommand* command,G4String newValue)
{
  ...
  {fDetector->SetPosition(fPositionCMD->GetNewDoubleValue(newValue));}

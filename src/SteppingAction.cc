	  	...
	  	if(thePostPoint->GetStepStatus()==fGeomBoundary){
	  		...
	  		switch(boundaryStatus){
		      	...
		      	case Detection:
		      	{
						...
						//	G4cout << 1240/(theTrack->GetKineticEnergy()/eV) <<G4endl;
							fEventAction->AddWavelength(1240/(theTrack->GetKineticEnergy()/eV));

							//analysisManager->FillH1(2, 1240/(theTrack->GetKineticEnergy()/eV));
			      	break;
		      	}
